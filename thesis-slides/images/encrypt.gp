...
plot "encrypt-gpu.dat" title "GPU" with linespoints linewidth 4 pointtype 5 linetype 1,\
     "encrypt-cpu.dat" title "CPU" with linespoints linewidth 4 pointtype 9 linetype 2,\
     "encrypt-serial.dat" title "Seriale" with linespoints linewidth 4 pointtype 7 linetype 3
